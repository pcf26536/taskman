...
export const preloadedTasks = [
  ...
  */
  ...
  complete: [], incomplete: [], 
  reminder: nowTimestamp + (10 * minutesMultiplier), pinned: true, edited: nowTimestamp + (1 * minutesMultiplier), created: nowTimestamp+ (1 * minutesMultiplier), trashed: false, done: false },
